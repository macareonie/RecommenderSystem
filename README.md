...
Personal recommender system leveraging a manual algorithm to generate anime recommendations according to personal taste, leveraging my own ratings done on MyAnimeList over the years.
